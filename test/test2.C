...
#include "HiggsAnalysis/Jet2TauFakes/interface/WrapperTFormula.h"
#include "HiggsAnalysis/Jet2TauFakes/interface/IFunctionWrapper.h"
#include "HiggsAnalysis/Jet2TauFakes/interface/FakeFactor.h"
